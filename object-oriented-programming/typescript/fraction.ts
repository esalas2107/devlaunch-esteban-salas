...
const createFraction = (numerator: number, denominator: number): Fraction => {
    return {
        ...
        add: function (fraction: Fraction) {
            if (this.denominator === fraction.denominator) {
                return {
                    numerator: this.numerator + fraction.numerator,
                    denominator: this.denominator
...
function multiply(fraction1: Fraction, fraction2: Fraction) {
    return {
...
function split(fraction1: Fraction, fraction2: Fraction) {
    return {
...
function subtract(fraction1: Fraction, fraction2: Fraction) {
...
function add(fraction1: Fraction, fraction2: Fraction) {
    if (fraction1.denominator === fraction2.denominator) {
        return {
            numerator: fraction1.numerator + fraction2.numerator,
            denominator: fraction1.denominator
...
const fraction3: Fraction = createFraction(3, 4)
const fraction4: Fraction = createFraction(2, 3)
